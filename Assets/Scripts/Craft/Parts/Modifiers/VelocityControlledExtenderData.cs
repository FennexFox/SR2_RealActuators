namespace Assets.Scripts.Craft.Parts.Modifiers
{
    ...
    public class VelocityControlledExtenderData : PartModifierData<VelocityControlledExtenderScript>
    {
        ...
        [SerializeField]
        [DesignerPropertySlider(0.1f, 200f, 2000, Label = "Velocity", Order = 0, Tooltip = "Change the velocity of the extender.")]
        ...
        {
            d.OnValueLabelRequested(() => _velocity, (float x) => x.ToString("0.00") + "m/s");
